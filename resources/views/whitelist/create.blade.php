            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('whitelist') }}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-8">
                                    <select name="orgid" id="orgid" class="form-control select" >
                                        ...
                                        @foreach($org_lists as $row)
                                            <option value="{{$row->orgid}}" title="{{$row->orglongname}}" @if ($row->orgid==old('orgid')) selected @endif>({{$row->orgid}}){{$row->orgname}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('node_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="node_id" value="{{ old('node_id') }}" id="node_id" class="form-control">
                            ...
                            <div class="form-group{{ $errors->has('accountid') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="accountid" value="{{ old('accountid') }}" id="accountid" class="form-control">
                            ...
                            <div class="form-group{{ $errors->has('custid') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="custid" value="{{ old('custid')}}" id="custid" class="form-control">
                            ...
                            <div class="form-group{{ $errors->has('fundid') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="fundid" value="{{ old('fundid')}}" id="fundid" class="form-control">
                            ...
                            <div class="form-group{{ $errors->has('max_connection') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="max_connection" value="{{ old('max_connection')}}" id="max_connection" class="form-control">
                                ...
                                <div class="col-md-8">
                                    <select name="bind_oms" id="bind_oms" class="form-control select" >
                                        ...
                                        @foreach($trade_lists as $row)
                                            <option value="{{$row->id}}" title="{{$row->server_summary}}" @if ($row->id==old('bind_oms')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8">
                                    <select name="bind_quote" id="bind_quote" class="form-control select" >
                                        ...
                                        @foreach($quote_lists as $row)
                                            <option value="{{$row->id}}" title="{{$row->server_summary}}" @if ($row->id==old('bind_quote')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
