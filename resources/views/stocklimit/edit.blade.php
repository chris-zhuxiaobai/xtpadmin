            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('stocklimit/'.$stocklimit->id) }}">
                            ...
                            <div class="form-group{{ $errors->has('exch_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <select name="exch_id" id="exch_id" class="form-control select" >
                                        ...
                                        <option value="1" @if (1==old('exch_id',$stocklimit->exch_id)) selected @endif>上交所</option>
                                        <option value="2" @if (2==old('exch_id',$stocklimit->exch_id)) selected @endif>深交所</option>
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('ticker') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="ticker" id="ticker" class="form-control" value="{{ old('ticker',$stocklimit->ticker) }}" />
                            ...
                            <div class="form-group{{ $errors->has('buy_qty_lower_limit') || $errors->has('sell_qty_upper_limit') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input type="text" name="buy_qty_lower_limit" id="buy_qty_lower_limit" class="form-control" value="{{ old('buy_qty_lower_limit',$stocklimit->buy_qty_lower_limit) }}" />
                                ...
                                <div class="col-md-2">
                                    <input type="text" name="buy_qty_upper_limit" id="buy_qty_upper_limit" class="form-control" value="{{ old('buy_qty_upper_limit',$stocklimit->buy_qty_upper_limit)}}" />
                            ...
                            <div class="form-group{{ $errors->has('sell_qty_lower_limit') || $errors->has('sell_qty_upper_limit') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input type="text" name="sell_qty_lower_limit" id="sell_qty_lower_limit" class="form-control" value="{{ old('sell_qty_lower_limit',$stocklimit->sell_qty_lower_limit)}}" />
                                ...
                                <div class="col-md-2">
                                    <input type="text" name="sell_qty_upper_limit" id="sell_qty_upper_limit" class="form-control" value="{{ old('sell_qty_upper_limit',$stocklimit->sell_qty_upper_limit)}}" />
                            ...
                            <div class="form-group{{ $errors->has('start_day') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="date" name="start_day" id="start_day" class="form-control" value="{{ old('start_day',$stocklimit->start_day)}}" />
                            ...
                            <div class="form-group{{ $errors->has('end_day') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="date" name="end_day" id="end_day" class="form-control" value="{{ old('end_day',$stocklimit->end_day)}}" />
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-5">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-btn fa-edit"></i> 保存
                                    </button>
