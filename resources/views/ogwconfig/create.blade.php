            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('ogwconfig') }}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-8">
                                    <select name="ogw_id" id="ogw_id" class="form-control select" >
                                        ...
                                        @foreach($ogw_lists as $row)
                                            <option value="{{$row->id}}" @if ($row->id==old('ogw_id')) selected @endif>[{{$row->sub_type==0?'上交所':'深交所'}}]{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('pbu_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="pbu_id" type="text" class="form-control" name="pbu_id" value="{{old('pbu_id')}}" />
