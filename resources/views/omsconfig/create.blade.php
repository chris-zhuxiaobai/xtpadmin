            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('omsconfig') }}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-8">
                                    <select name="oms_id" id="oms_id" class="form-control select" >
                                        ...
                                        @foreach($oms_lists as $row)
                                            <option value="{{$row->id}}" @if ($row->id==old('oms_id')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8">
                                    <select name="ogw_sh_id" id="ogw_sh_id" class="form-control select" >
                                        ...
                                        @foreach($ogws_sh as $row)
                                            <option value="{{$row->id}}" @if ($row->id==old('ogw_sh_id')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8">
                                    <select name="ogw_sz_id" id="ogw_sz_id" class="form-control select" >
                                        ...
                                        @foreach($ogws_sz as $row)
                                            <option value="{{$row->id}}" @if ($row->id==old('ogw_sz_id')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
