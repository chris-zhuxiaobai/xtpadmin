            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('ogwbranche') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('ogw_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <select name="ogw_id" id="ogw_id" class="form-control select" >
                                        ...
                                        @foreach($ogws as $row)
                                            <option value="{{$row->id}}" @if ($row->id==old('ogw_id')) selected @endif>{{$row->server_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('sno_start')||$errors->has('sno_end') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input id="sno_start" name="sno_start" type="text" class="form-control"  value="{{old('sno_start')}}" />
                                ...
                                <div class="col-md-2">
                                    <input id="sno_end" name="sno_end" type="text" class="form-control"  value="{{old('sno_end')}}" />
                                ...
                                <div class="col-md-1">
                                    <input id="is_whole" name="is_whole" type="checkbox" @if (old('is_whole')) checked @endif class="form-control"  value="1" />
